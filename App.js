  ...
  render() {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttons}>
        ...
        <Buttons label='9' onClick={this.addDig} />
        <Buttons label='*' operation onClick={this.setOperation} />
        <Buttons label='4' onClick={this.addDig} />
        <Buttons label='5' onClick={this.addDig} />
        <Buttons label='6' onClick={this.addDig} />
        <Buttons label='-' operation onClick={this.setOperation} />
        <Buttons label='1' onClick={this.addDig} />
